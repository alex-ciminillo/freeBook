        ...
        return (
                <div className='profileNavBar' >
                    <div>
                        ...
                        <div id='aboutNavButton' onClick={this.props.changeProfileNavbar.bind(this, 'about')} className='profileNavButtons' >
                            <div className='profileNavButtonsWord' >About</div>
                        </div>
                        <div id='friendsNavButton' onClick={this.props.changeProfileNavbar.bind(this, 'friends')} className='profileNavButtons' >
                            <div className='profileNavButtonsWord' >Friends</div>
                        </div>
                        <div id='photosNavButton' onClick={this.props.changeProfileNavbar.bind(this, 'photos')} className='profileNavButtons' >
