    ...
    render() {
        ...
        return this.props.currentUser ? (
            <div id='greetingMiddlePostsContainerTop' onClick={()=>this.clearSearchBar()} >
                <div className='profileBottomFullContainer3' >
                    <div className='profileBottomLeftSideOptionsContainer'>
                        <div onClick={()=>{this.props.history.push(`/users/${this.props.currentUser.id}`)}} className='profileBottomLeftSideOptions' >
                            <div>
                        ...
                        <div onClick={()=>this.props.showModal({modal: 'comingSoon', feature: 'Friends Page'})} className='profileBottomLeftSideOptions' >
                            <div>
                        ...
                        <div onClick={()=>this.props.showModal({modal: 'comingSoon', feature: 'Groups'})} className='profileBottomLeftSideOptions' >
                            <div>
                        ...
                        <div onClick={()=>this.props.showModal({modal: 'comingSoon', feature: 'Marketplace'})} className='profileBottomLeftSideOptions' >
                            <div>
                        ...
                        <div onClick={()=>this.props.showModal({modal: 'comingSoon', feature: 'Memories'})} className='profileBottomLeftSideOptions' >
                            <div>
                        ...
                        <div onClick={()=>window.open('https://www.hud.gov/i_want_to/get_involved_in_my_community', '_blank')} className='profileBottomLeftSideOptions' >
                            <div>
                        ...
                        <div onClick={()=>window.open('https://www.usgs.gov/programs/climate-adaptation-science-centers', '_blank')} className='profileBottomLeftSideOptions' >
                            <div>
                        ...
                        <div onClick={()=>window.open('https://www.cdc.gov/coronavirus/2019-ncov/index.html', '_blank')} className='profileBottomLeftSideOptions' >
                            <div>
                        ...
                        <div onClick={()=>window.open('https://greatnonprofits.org/near-me/', '_blank')} className='profileBottomLeftSideOptions' >
                            <div>
                                ...
                                <div className='profileBottomMakePostInner' >
                                    ...
                                    <div className='profileBottomMakePostButtons' >
                                        <div className='profileBottomMakePostButtonsInner' >
                                            <div onClick={()=>this.props.showModal({modal: 'comingSoon', feature: 'Live Videos'})} className='profileBottomMakePostButton' >
                                            ...
                                            <div onClick={()=>this.props.showModal({modal: 'comingSoon', feature: 'Life Events'})} className='profileBottomMakePostButton' >
                            ...
                            <div className='profileBottomPostsHeaderContainer' >
                                <div className='profileBottomPostsHeaderTop' >
                                    ...
                                    <div className='profileBottomPostsHeaderTopButtons'>
                                        <div onClick={()=>this.props.showModal({modal: 'comingSoon', feature: 'Filters'})} className='profileBottomPostsHeaderTopFilter' >
                                        ...
                                        <div onClick={()=>this.props.showModal({modal: 'comingSoon', feature: 'Manage Posts'})} className='profileBottomPostsHeaderTopManage' >
                                ...
                                <div className='profileBottomPostsHeaderGrayLine' ></div>
                                 <div className='profileBottomPostsHeaderBottom' >
                                    ...
                                    <div onClick={()=>this.props.showModal({modal: 'comingSoon', feature: 'Grid View'})} className='profileBottomPostsHeaderBottomButton'>
            ...
            <div className='greetingContainer' >
                ...
                <div>
                    <div><span  onClick={()=>this.props.showModal({modal: 'comingSoon', feature: 'Pages'})}  >Create a Page</span> for a celebrity, brand or business.</div>
                </div>
                </div>
            </div>
                <div className='greetingFooterDiv' >
                    ...
                    <div className='greetingLanguages' >
                        <div onClick={()=>this.props.showModal({modal: 'comingSoon', feature: 'Languages'})} >English (US)</div>
                        <div onClick={()=>this.props.showModal({modal: 'comingSoon', feature: 'Languages'})} >Español</div>
                        <div onClick={()=>this.props.showModal({modal: 'comingSoon', feature: 'Languages'})} >Français (France)</div>
                        <div onClick={()=>this.props.showModal({modal: 'comingSoon', feature: 'Languages'})} >中文(简体)</div>
                        <div onClick={()=>this.props.showModal({modal: 'comingSoon', feature: 'Languages'})} >العربية</div>
                        <div onClick={()=>this.props.showModal({modal: 'comingSoon', feature: 'Languages'})} >Português (Brasil)</div>
                        <div onClick={()=>this.props.showModal({modal: 'comingSoon', feature: 'Languages'})} >Italiano</div>
                        <div onClick={()=>this.props.showModal({modal: 'comingSoon', feature: 'Languages'})} >한국어</div>
                        <div onClick={()=>this.props.showModal({modal: 'comingSoon', feature: 'Languages'})} >हिन्दी</div>
                        <div onClick={()=>this.props.showModal({modal: 'comingSoon', feature: 'Languages'})} >日本語</div>
                        <div onClick={()=>this.props.showModal({modal: 'comingSoon', feature: 'Languages'})}  className='greetingLanguagesPlus' >
