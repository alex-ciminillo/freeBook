                    ...
                    <form onSubmit={this.handleSubmit}>
                        <div className='signUpInputs' >
                            <div className='signUpFirstAndLast' >
                                <input id='firstName' type="text" placeholder='First name' value={this.state.firstName} onChange={this.update('firstName')} />
                                <input id='lastName' type="text" placeholder='Last name' value={this.state.lastName} onChange={this.update('lastName')} />
                            </div>
                            <div className='signUpMobileEmailPassword' >
                                <input type="text" placeholder='Mobile number or email' value={this.state.username} onChange={this.update('username')} />
                            </div>
                            <div className='signUpMobileEmailPassword' >
                                <input type="password" placeholder='New password' value={this.state.password} onChange={this.update('password')} />
                            </div>
                        </div>
                        ...
                        <div className='signUpGender' >
                            ...
                            <div className='signUpGenderChoice' >
                                <span  data-type="radio" data-name="gender_wrapper" id="u_1_o_Op">
                                    <span >
                                        <label  >Female</label>
                                        <input type="radio"  name="sex" value="1" id="u_1_2_X0"/>
                                    </span>
                                    <span >
                                        <label  >Male</label>
                                        <input type="radio"  name="sex" value="2" id="u_1_3_qK"/>
                                    </span>
                                    <span >
                                        <label  >Custom</label>
                                        <input type="radio"  name="sex" value="-1" id="u_1_4_Tm"/>
                                    </span>
                                </span>
                            </div>
                        </div>
